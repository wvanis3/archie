...
beautiful.wallpaper = "/home/will/Pictures/Wallpapers/skyline.jpg"
beautiful.border_width = 2
beautiful.border_color = "#ffffff"
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey }, "r", function () awful.spawn(terminal .. " -e " .. filemanager) end,
